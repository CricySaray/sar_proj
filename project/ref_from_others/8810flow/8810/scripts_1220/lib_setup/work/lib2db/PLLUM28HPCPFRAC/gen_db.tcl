...
set all_libs  [glob /eda_files/proj/ict8810/archive/11-ip/siliconcreation/PLLUM28HPCPFRAC_2023_06_20_v1p0p0p1p3/PLLUM28HPCPFRAC/lib/*lib]
foreach lib $all_libs {
	read_lib $lib
	set ip_name [get_object_name  [get_lib *]]
#	regexp ".*${ip_name}_(.*).lib" $lib a corner
	regexp ".*PLLUM28HPCPFRAC_(.*).lib" $lib a corner
