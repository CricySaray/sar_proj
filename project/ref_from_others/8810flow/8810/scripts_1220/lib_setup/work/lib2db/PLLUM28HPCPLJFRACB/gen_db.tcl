...
set all_libs  [glob /eda_files/proj/ict8810/archive/11-ip/siliconcreation/PLLUM28HPCPLJFRACB_2023_11_21_v1p0p0p2p4/PLLUM28HPCPLJFRACB/lib/*lib]
foreach lib $all_libs {
	read_lib $lib
	set ip_name [get_object_name  [get_lib *]]
#	regexp ".*${ip_name}_(.*).lib" $lib a corner
	regexp ".*PLLUM28HPCPLJFRACB_(.*).lib" $lib a corner
