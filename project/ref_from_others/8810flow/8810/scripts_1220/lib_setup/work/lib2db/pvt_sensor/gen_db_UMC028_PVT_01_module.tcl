...
set all_libs  [glob /eda_files/proj/ict8810/archive/11-ip/pvt_sensor/20240528_028UMC_PVT_01_database_release_v1.0/Abstracts/LIB/UMC028_PVT_01_module*lib]
foreach lib $all_libs {
	read_lib $lib
	set ip_name [get_object_name  [get_lib *]]
	regexp ".*UMC028_PVT_01_module_(.*).lib" $lib a corner
