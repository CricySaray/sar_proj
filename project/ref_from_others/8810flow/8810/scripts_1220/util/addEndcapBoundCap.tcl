proc invsAddEnd {} {
	...
	if {[regexp {^SMIC} $vars(library)] || [regexp {ARM} $vars(library)]} { 
		setEndCapMode -prefix $vars(cap_prefix) \
			-topEdge "FILL2_A7PP140ZTS_C35 FILL3_A7PP140ZTS_C35 FILL4_A7PP140ZTS_C35" \
			-bottomEdge "FILL2_A7PP140ZTS_C35 FILL3_A7PP140ZTS_C35 FILL4_A7PP140ZTS_C35" \
		...
		setEndCapMode -prefix $vars(cap_prefix) \
			-topEdge "FILL3BWP7T35P140 FILL2BWP7T35P140" \
			-bottomEdge "FILL3BWP7T35P140 FILL2BWP7T35P140" \
