proc userExtractLibLef {} {
    ...
    write_lef_abstract -5.8 -PGPinLayers {ME7 ME8 AL_RDL} -extractBlockObs -specifyTopLayer ME7 $lef_dir/[dbgDesignName].$vars(step).$vars(view_rpt).lef -stripePin
	##abstract lib 
	set_analysis_view -setup {func_wcl_cworst_t scan_wcl_cworst_t } -hold {func_ml_rcworst scan_ml_rcworst func_wcl_rcworst scan_wcl_rcworst }
...
#usage :
#set vars(step) place 
#set vars(view_rpt) V0303_S0303_FP0222_030301
#userExtractLibLef
