...
proc report_cell_status {} {
    ...
    foreach ckcell [lsort -u [get_attribute $clock_cells ref_name]] {
        foreach vt [array names cell_vt_group] {
            foreach ptn $cell_vt_group($vt) {
    ...
    foreach VT $mixVT_list {
        set num($VT) 0
        foreach vt_group $cell_vt_group($VT) {
...
proc report_vt_usage {} {
    ...
    foreach {vtptn ptn } $env(cell_vt_group) {
            set area 0
...
proc report_connectivity_status {} {
    reportHead "Memory Connection Information"
