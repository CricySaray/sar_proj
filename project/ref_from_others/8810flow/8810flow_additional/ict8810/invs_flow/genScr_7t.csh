...
ln -s $rel/util $loc/scr/util

ln -s $rel/global.invs $loc/scr/global.invs
ln -s $rel/viewDefine.invs $loc/scr/viewDefine.invs
cp $rel/run.csh $loc/scr/run.csh
ln -s $rel/setup.invs.7t $loc/scr/setup.invs
