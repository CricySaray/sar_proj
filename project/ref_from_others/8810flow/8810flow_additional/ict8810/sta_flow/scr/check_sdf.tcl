...
set dmsa_mode_constraint_files(func) "/eda_files/proj/ict2100/backend/be2101/chip_top_fdp/sta_pt/input/sdc/chip_top.func.default.sdc"
...
set SDF     	"/eda_files/proj/ict2100/backend/zhangwenjie/chip_top_fdp/sub_proj/chip_top/dsn/sdf/${DESIGN_TOP}.${MODE}_${CORNER}_${check}.${VIEW}.sdf.gz"
