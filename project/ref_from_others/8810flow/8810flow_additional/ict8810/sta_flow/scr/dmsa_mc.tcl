...
#        set_timing_derate  -cell_delay  -clock -increment  -early  -0.054  [ get_lib_cells *0p81v125c*/SFLVTPA28_512X80BW64b1]       
    ...
    if {[string match wcz_* $corner ]} {
        ...
        set_timing_derate  -cell_delay  -clock -increment  -early  -0.041  [ get_lib_cells *0p81v_0c*/*ZTL*]
...
#        set_timing_derate  -cell_delay  -clock -increment  -early  -0.080 [get_lib_cells *0p90v85c*/SFLVTPA28_512X80BW64b1]
        ...
        set_timing_derate  -cell_delay  -clock -data -increment  -late  0.061 [get_lib_cells *typical_max_0p90v_85c*/*ZTS*]
        set_timing_derate  -cell_delay  -clock -data -increment  -late  0.044 [get_lib_cells *typical_max_0p90v_85c*/*ZTH*]
        set_timing_derate  -cell_delay  -clock -data -increment  -late  0.040 [get_lib_cells *typical_max_0p90v_85c*/*ZTL*]
        set_timing_derate  -cell_delay  -clock -data -increment  -late  0.038 [get_lib_cells *typical_max_0p90v_85c*/*ZTUL*]
#        set_timing_derate  -cell_delay  -clock -data -increment  -late  0.08 [get_lib_cells *0p90v85c*/FXEDP447EWHJ0P]
#        set_timing_derate  -cell_delay  -clock -data -increment  -late  0.08 [get_lib_cells *0p90v85c*/SFLVTPA28_512X80BW64b1]
    }
    if {[string match typ_85 $corner ] && ( [string match func2 $mode ] ||[string match func3 $mode ] ) } {
        ...
        set_timing_derate  -cell_delay  -clock -increment  -early  -0.046 [get_lib_cells *typical_max_1p00v_85c*/*ZTUL*]
...
#        set_timing_derate  -cell_delay  -clock -increment  -late  0.136 [get_lib_cells *0p90v85c*/SFLVTPA28_512X80BW64b1]
        ...
        set_timing_derate  -cell_delay  -clock -increment -data -early  -0.074 [get_lib_cells *typical_max_0p90v_85c*/*ZTS*]
        set_timing_derate  -cell_delay  -clock -increment -data -early  -0.103 [get_lib_cells *typical_max_0p90v_85c*/*ZTH*]
        set_timing_derate  -cell_delay  -clock -increment -data -early  -0.065 [get_lib_cells *typical_max_0p90v_85c*/*ZTL*]
        set_timing_derate  -cell_delay  -clock -increment -data -early  -0.065 [get_lib_cells *typical_max_0p90v_85c*/*ZTUL*]
#        set_timing_derate  -cell_delay  -clock -increment -data -early  -0.136 [get_lib_cells *0p90v85c*/FXEDP447EWHJ0P]
#        set_timing_derate  -cell_delay  -clock -increment -data -early  -0.136 [get_lib_cells *0p90v85c*/SFLVTPA28_512X80BW64b1]
    }
    if {[string match typ_85 $corner ] && ( [string match func2 $mode ] || [string match func3 $mode ]) } {
...
if {[regexp {_setuphold} [current_scenario]]} {
