...
deselectAll ;editSelect -layer M1 -net  DVDD0P9_AON_SLP -area [dbShape [dbGet [dbGet top.pds.group.name PD_AON_SLP  -p].boxes]]
editChangeNet -to DVDD0P9_AON
...
set decap_box {{129.975 2380.5 147.475 2516.3} {147.755 2546.4 198.295 2563.2} {129.975 2591.9 147.195 2876.1} {147.615 2577.2 184.995 2589.8} {147.335 2589.8 238.755 2636.0}}
addDeCap -prefix spare_decap -cells $gdcap_cell -totCap 999999 -exclude $decap_box
addDeCap -prefix spare_filler -cells $gfiller -totCap 999999 -exclude $decap_box
deletePlaceBlockage tmpBLK_GDCAP
addDeCap -prefix decap -cells $decap_cell -totCap 999999 -exclude $decap_box
...
deselectAll ;editSelect -layer M1 -net  DVDD0P9_AON -area [dbShape [dbGet [dbGet top.pds.group.name PD_AON_SLP  -p].boxes]]
editChangeNet -to DVDD0P9_AON_SLP
