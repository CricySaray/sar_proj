proc userCreateM2FollowPin {width_pwr width_gnd layer_num shrink_width} {
	global vars
	...
	setEdit -layer_minimum M2
	setEdit -layer_maximum M2
	setEdit -drc_on 0
	deselectAll
	foreach pgNetPtr [dbget -p1 top.nets.isPwr 1] {
		editSelect -layer M1 -shape FOLLOWPIN -net [dbget $pgNetPtr.name]
	}
	editDuplicate
	editChangeLayer
