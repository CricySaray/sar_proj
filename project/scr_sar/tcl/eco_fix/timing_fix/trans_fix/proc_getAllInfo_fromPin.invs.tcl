...
proc get_allInfo_fromPin {{pinname ""} {forbidenVT {AH9}} {driveCapacityRange {1 12}}} {
  if {$pinname == "" || $pinname == "0x0" || [dbget top.insts.instTerms.name $pinname -e] == ""} {
    ...
    dict set allInfo ruleLen [eo [expr [dict get $allInfo numSinks] == 1] [dict get $allInfo distanceOfDriver2CenterOfSinksPinPt] [lindex $resultOfIfLoop_forOne2More end]]
