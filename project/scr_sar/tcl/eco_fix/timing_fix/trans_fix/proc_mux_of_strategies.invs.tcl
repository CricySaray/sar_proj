    ...
    dict with resultDict {
      ...
      if {!$ifPassPreCheck} { ; # NOTICE: include nonConsider and dirtyCase list
        ...
        switch -regexp $driverSinksSymbol {
          ...
          "^m?\[ls\]b$"       {set crosspointOfChangeCapacityAndInsertBuffer {20 20} ; set crosspointOfChangeVTandCapacity {5 5} ; set mapList {{0.5 4} {1 4} {2 4} {3 8} {4 8} {8 8}} ; set relativeLoc 0.9 ; set addMethod "refDriver" ; set capacityRange {4 12}}
          "^m?\[ls\]\[ls\]$"  {set crosspointOfChangeCapacityAndInsertBuffer {10 10} ; set crosspointOfChangeVTandCapacity {3 3} ; set mapList {{0.5 4} {1 4} {2 4} {3 8} {4 8} {8 8}} ; set relativeLoc 0.9 ; set addMethod "refDriver" ; set capacityRange {4 12}}
