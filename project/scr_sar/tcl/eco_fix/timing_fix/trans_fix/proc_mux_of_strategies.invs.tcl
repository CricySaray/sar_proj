...
proc sliding_rheostat_of_strategies {args} {
  ...
  if {![string is double $violValue] || [expr $violValue > 0] || $violPin == "" || $violPin == "0x0" || [dbget top.insts.instTerms.name $violPin -e] == ""} {
    ...
    dict with resultDict {
      ...
      set ifDirtyCase [expr !$numSinks || !$netLen ] ; # if 1: have problem, you can add || !$ifNetConnected
      ...
      if {!$ifPassPreCheck} { ; # NOTICE: include nonConsider and dirtyCase list
        ...
        switch -regexp $driverSinksSymbol {
          "^m?b\[ls\]$"       {set crosspointOfChangeCapacityAndInsertBuffer {15 15} ; set crosspointOfChangeVTandCapacity {4 4} ; set mapList {{0 2} {1 3} {1.5 4} {2 4} {3 6} {4 6} {6 8} {8 12}} ; set relativeLoc 0.3 ; set addMethod "refDriver" ; set capacityRange {2 12} ; set lowestDriveCapacityWhenShortNetLenBigViolValue 4 ; set biggestThresholdViolValueWhenU012 -0.05} ; # $lowestDriveCapacityWhenShortNetLenBigViolValue and $biggestThresholdViolValueWhenU012 : U012
          "^m?bb$"            {set crosspointOfChangeCapacityAndInsertBuffer {25 25} ; set crosspointOfChangeVTandCapacity {6 6} ; set mapList {{0 3} {1 3} {1.5 4} {2 4} {3 6} {4 6} {6 12} {8 12}} ; set relativeLoc 0.4 ; set addMethod "refSink" ; set capacityRange {2 12} ; set lowestDriveCapacityWhenShortNetLenBigViolValue 2 ; set biggestThresholdViolValueWhenU012 -0.04}
          "^m?\[ls\]b$"       {set crosspointOfChangeCapacityAndInsertBuffer {20 20} ; set crosspointOfChangeVTandCapacity {5 5} ; set mapList {{0 2} {1 2} {1.5 2} {2 2} {3 4} {4 4} {6 4} {8 4}} ; set relativeLoc 0.9 ; set addMethod "refDriver" ; set capacityRange {2 12} ; set lowestDriveCapacityWhenShortNetLenBigViolValue 4 ; set biggestThresholdViolValueWhenU012 -0.06 }
          "^m?\[ls\]\[ls\]$"  {set crosspointOfChangeCapacityAndInsertBuffer {10 10} ; set crosspointOfChangeVTandCapacity {3 3} ; set mapList {{0 2} {1 2} {1.5 2} {2 2} {3 4} {4 4} {6 4} {8 4}} ; set relativeLoc 0.9 ; set addMethod "refDriver" ; set capacityRange {2 12} ; set lowestDriveCapacityWhenShortNetLenBigViolValue 4 ; set biggestThresholdViolValueWhenU012 -0.06}
          default             {set crosspointOfChangeCapacityAndInsertBuffer {15 15} ; set crosspointOfChangeVTandCapacity {4 4} ; set mapList {{0 2} {1 3} {1.5 4} {2 4} {3 6} {4 6} {6 8} {8 12}} ; set relativeLoc 0.5 ; set addMethod "refDriver" ; set capacityRange {2 12} ; set lowestDriveCapacityWhenShortNetLenBigViolValue 2 ; set biggestThresholdViolValueWhenU012 -0.05 ; set ifNeedConsiderThisDriverSinksSymbol 1}
        }
          ...
          if {$numOfMostFrequentInSinksCellClass == 1} { ; # U007: this judgement is simple , you need improve it after
            ...
            if {![operateLUT -type exists -attr [list celltype $toAdd]]} {
              ...
              if {$ifOne2One} {
                ...
                set toLoc [calculateRelativePoint $centerPointOfFartherGroupSinksPin $driverPinPT $relativeLoc]
              ...
              set cmd [print_ecoCommand -type add -celltype $toAdd -terms $termsWhenAdd -newInstNamePrefix ${newInstNamePrefix}_one2[eo $ifOne2One one more]_[ci one] -loc $refineLocPosition]
