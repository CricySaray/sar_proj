...
proc genCmd_consolidateLibPaths {args} {
  set lefListFileName ""
  set libListDividedByCornersFileName "" ; # This type of lib list file needs to be grouped by corner names, and then variable settings for each group should be made through the files generated after grouping.
  set libListAllCornersFileName ""
  set 
