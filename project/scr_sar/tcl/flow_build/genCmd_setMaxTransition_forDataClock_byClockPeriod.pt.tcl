...
# ref       : link url
# --------------------------
proc genCmd_setMaxTransition_forDataClock_byClockPeriod {args} {
...
define_proc_attributes genCmd_setMaxTransition_forDataClock_byClockPeriod \
  -info "gen cmd for set_max_transition by clock period, it will return the min value of max_transition"\
  -define_args {
