...
#                   and then : set_global report_timing_format {hpin cell [load fanout pin_location user_derate socv_derate total_derate ... delay_mean delay_sigma slew incr_delay] delay arrival}
