...
proc collect_sum_csv_file_pure_withoutDefineArgumentCmd {{searchDir "./"} {formatOfScenarios ""} {modesOfFormatExp {}} {typeToCheckOfFormatExp {}} {voltageOfFormatExp {}} {rcCornerOfFormatExp {}} {temperatureOfFormatExp {}}} {
  ...
  set allCasesOfScenarios [generate_combinations -connector "_" {*}[lmap temp_var [regsub -all {>|<} $optionsOfFormatOfScenarios ""] { if {![llength [subst \${$temp_var}]]} {error "proc collect_sum_csv_file_pure_withoutDefineArgumentCmd: check your input: the $temp_var is empty!!!"} else {set $temp_var}}]]
...
# instance invoked proc: collect_sum_csv_file_pure_withoutDefineArgumentCmd
if {1} {
  ...
  collect_sum_csv_file_pure_withoutDefineArgumentCmd $searchDir $formatOfScenarios $modesOfFormatExp $typeToCheckOfFormatExp $voltageOfFormatExp $rcCornerOfFormatExp $temperatureOfFormatExp
}

# with define_proc_arguments cmd
proc collect_sum_csv_file_withDefineArgumentCmd {args} {
  set searchDir              "./"
  set formatOfScenarios      "<mode>_<type>_<voltage>_<rcCorner>_<temperature>"
  set modesOfFormatExp       {func scan}
  set typeToCheckOfFormatExp {setup hold}
  ...
  set optionsOfFormatOfScenarios [list "<mode>" "<type>" "<voltage>" "<rcCorner>" "<temperature>"] ; # you only select options inside these
  set mode $modesOfFormatExp ; set type $typeToCheckOfFormatExp ; set voltage $voltageOfFormatExp ; set rcCorner $rcCornerOfFormatExp ; set temperature $temperatureOfFormatExp
  set allCasesOfScenarios [generate_combinations -connector "_" {*}[lmap temp_var [regsub -all {>|<} $optionsOfFormatOfScenarios ""] { if {![llength [subst \${$temp_var}]]} {error "proc collect_sum_csv_file_withDefineArgumentCmd: check your input: the $temp_var is empty!!!"} else {set $temp_var}}]]
  if {![file isdirectory $searchDir]} {
...
define_proc_arguments collect_sum_csv_file_withDefineArgumentCmd \
