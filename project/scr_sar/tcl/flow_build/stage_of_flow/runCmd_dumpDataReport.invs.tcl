...
# --------------------------
# author    : sar song
# date      : 2025/09/27 10:58:11 Saturday
# label     : flow_proc
...
# descrip   : dump data report for all stage on invs
# return    : /
# ref       : link url
# --------------------------
proc runCmd_dumpDataReport {args} {
  set stage "init" ; # init|floorplan|place|cts|postcts|route|postroute|chipfinish
...
define_proc_arguments runCmd_dumpDataReport \
  -info "dump data report for all stage on invs"\
  -define_args {
